...
class Firestore {
    ...
    constructor(settings) {
        ...
        this._clientPool =
            new pool_1.ClientPool(MAX_CONCURRENT_REQUESTS_PER_CLIENT, () => {
    ...
    settings(settings) {
        ...
        validate_1.validateBoolean('settings.timestampsInSnapshots', settings.timestampsInSnapshots, { optional: true });
  ...
  behavior.`);
            ...
            this._settingsFrozen = true;
            if (this._projectId === undefined) {
                this._projectId = yield this._clientPool.run(gapicClient => {
                    return new Promise((resolve, reject) => {
