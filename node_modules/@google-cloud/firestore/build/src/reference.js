...
class CollectionReference extends Query {
    ...
    listDocuments() {
        return this.firestore.initializeIfNeeded().then(() => {
            const resourcePath = this._path.toQualifiedResourcePath(this.firestore.projectId);
            ...
            return this.firestore
                .request('listDocuments', request, util_1.requestTag(), /*allowRetries=*/ true)
                .then(documents => {
...
function validateQueryValue(arg, value) {
    serializer_1.validateUserInput(arg, value, 'query constraint', { allowDeletes: 'none', allowTransforms: false });
}
/**
